        ...
        <div className="lg:col-span-1 mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
              ...
              <p className='opacity-50 text-sm'>3425 Ratings</p>
              <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>345 Reviews</p>
              </div>
            </div>
            ...
            <form className="mt-10">
              ...
              <Button onClick={handleAddToCart} variant='contained' sx={{p:"2rem", py:"1rem", mt:"1rem", bgcolor:"#9155fd"}}>
                Add to cart
              </Button>
              ...
              <Grid container spacing={7}>
                    ...
                    <Grid item xs={5}>
                      ...
                      <div className='flex items-center space-x-3 '>
                        ...
                        <p className='opacity-60 '>34540 Ratings</p>
                      </div>
